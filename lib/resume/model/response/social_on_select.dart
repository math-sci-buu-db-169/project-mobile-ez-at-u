...
/// data_on_select : {"position_on_select":[{"id":1,"onselect":true}],"experience_on_select":[{"id":1,"onselect":true}],"education_on_select":{"hsc_on_select":[{"id":1,"onselect":true}],"bd_on_select":[{"id":1,"onselect":true}],"md_on_select":[{"id":1,"onselect":true}],"dd_on_select":[{"id":1,"onselect":true}],"hdd_on_select":[{"id":1,"onselect":true}]},"skill_on_select":[{"id":1,"onselect":true}],"certificate_on_select":[{"id":1,"onselect":true}],"language_on_select":[{"id":1,"onselect":true}],"social_on_select":{"onselected_email":false,"onselected_phone":false,"onselected_facebook":false,"onselected_line":false,"onselected_instagram":false,"onselected_twitter":false,"onselected_youtube":false}}
...
/// position_on_select : [{"id":1,"onselect":true}]
/// experience_on_select : [{"id":1,"onselect":true}]
/// education_on_select : {"hsc_on_select":[{"id":1,"onselect":true}],"bd_on_select":[{"id":1,"onselect":true}],"md_on_select":[{"id":1,"onselect":true}],"dd_on_select":[{"id":1,"onselect":true}],"hdd_on_select":[{"id":1,"onselect":true}]}
/// skill_on_select : [{"id":1,"onselect":true}]
/// certificate_on_select : [{"id":1,"onselect":true}]
/// language_on_select : [{"id":1,"onselect":true}]
...
/// hsc_on_select : [{"id":1,"onselect":true}]
/// bd_on_select : [{"id":1,"onselect":true}]
/// md_on_select : [{"id":1,"onselect":true}]
/// dd_on_select : [{"id":1,"onselect":true}]
/// hdd_on_select : [{"id":1,"onselect":true}]
