...
AlertLogoutHomeResponse alertLogoutHomeResponseFromJson(String str) =>
    AlertLogoutHomeResponse.fromJson(json.decode(str));
String alertLogoutHomeResponseToJson(AlertLogoutHomeResponse data) => json.encode(data.toJson());

class AlertLogoutHomeResponse {
  AlertLogoutHomeResponse({
    Head? head,
    Body? body,
  }) {
    _head = head;
  ...
  AlertLogoutHomeResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  AlertLogoutHomeResponse copyWith({
    Head? head,
    Body? body,
  }) =>
      AlertLogoutHomeResponse(
