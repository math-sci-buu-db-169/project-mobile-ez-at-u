...
AlertRegisterResponse alertRegisterResponseFromJson(String str) => AlertRegisterResponse.fromJson(json.decode(str));
String alertRegisterResponseToJson(AlertRegisterResponse data) => json.encode(data.toJson());

class AlertRegisterResponse {
  ...
  AlertRegisterResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  AlertRegisterResponse copyWith({
    Head? head,
    Body? body,
  }) =>
      AlertRegisterResponse(
