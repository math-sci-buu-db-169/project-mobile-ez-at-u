...
AlertPDPAResponse alertPDPAResponseFromJson(String str) => AlertPDPAResponse.fromJson(json.decode(str));
String alertPDPAResponseToJson(AlertPDPAResponse data) => json.encode(data.toJson());

class AlertPDPAResponse {
  AlertPDPAResponse({
    Head? head,
    Body? body,
  }) {
  ...
  AlertPDPAResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  AlertPDPAResponse copyWith({
    Head? head,
    Body? body,
  }) =>
      AlertPDPAResponse(
