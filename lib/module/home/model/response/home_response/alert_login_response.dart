...
AlertLoginHomeResponse alertLoginHomeResponseFromJson(String str) => AlertLoginHomeResponse.fromJson(json.decode(str));
String alertLoginHomeResponseToJson(AlertLoginHomeResponse data) => json.encode(data.toJson());

class AlertLoginHomeResponse {
  AlertLoginHomeResponse({
    Head? head,
    Body? body,
  }) {
    _head = head;
  ...
  AlertLoginHomeResponse.fromJson(dynamic json) {
    _head = json['head'] != null ? Head.fromJson(json['head']) : null;
    _body = json['body'] != null ? Body.fromJson(json['body']) : null;
  }
  Head? _head;
  Body? _body;
  AlertLoginHomeResponse copyWith({
    Head? head,
    Body? body,
  }) =>
      AlertLoginHomeResponse(
